...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between flex-column flex-md-column flex-lg-row align-items-center">
                    <div class="">
                        <h5 class="fw-bold m-0"><?= $employeename ?></h5>
                ...
                <ul class="d-none">
                    ...
                    <?php foreach ($attendance as $entry): ?>
                        ...
                        <?php foreach ($approvedLeaves as $leave): ?>
                            <data class="leave-date" data-leavedate="<?= $leave->FROM_DATE ?>" data-leavetype="<?= $leave->TYPE ?>" data-leavereason="<?= $leave->REASON ?>"
                                data-leavedays='<?= $leave->DAYS ?>'><?= $leave->FROM_DATE ?></li>
                            <?php endforeach; ?>
                </ul>
    ...
    <div class="col-lg-4">
        ...
        <div class="">
            <?= view("dashboard/components/accumulated-leavecredit", $dataArray); ?>
        </div>
    </div>
</div>